 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |      |  Spc |Lower |Raise | Bksp | Left | Down |  Up  |Right |
 * |      |      |      |      |      |      |      |      |      | Alt  |  GUI | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, _______, KC_SPC,  LOWER,   RAISE,   KC_BSPC, KC_LEFT, RALT_T(KC_DOWN), RGUI_T(KC_UP),   RCTL_T(KC_RGHT)
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   A  |   O  |   E  |   U  |   I  |   D  |   H  |   T  |   N  |   S  |      |
 * |Raise | Ctrl | GUI  | Alt  |Shift |      |      |Shift |  Alt |  GUI | Ctrl |Lower |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |   ;  |   Q  |   J  |   K  |   X  |   B  |   M  |   W  |   V  |   Z  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, LT(LNAV, KC_ESC), LT(SYM, KC_SPC),  LT(SYM, KC_TAB), LT(SYM, KC_RALT), LT(SYM, KC_BSPC), LT(RNAV, KC_ENT), OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RCTL)
    ),
 ...
 * |      |      |      |Pg Up | Home |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Left | Down |  Up  |Right |      |      |Shift |  Alt |  GUI | Ctrl |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |Pg Dn | End  |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_RNAV] = LAYOUT_planck_grid(
    _______, _______, _______, KC_PGUP, KC_HOME, _______, _______, _______, _______, _______, _______, _______,
    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, _______,
    _______, _______, _______, KC_PGDN, KC_END,  _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
...
[_SYM] = LAYOUT_planck_grid(
    _______, KC_GRV,  KC_TILD, KC_ASTR, KC_AMPR, _______, _______, KC_LPRN, KC_RPRN, KC_SLSH, KC_QUES, _______,
