...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, LT(LNAV, KC_ESC), LT(SYM, KC_SPC),  LT(NUM, KC_TAB), LT(NUM, KC_RALT), LT(SYM, KC_BSPC), LT(RNAV, KC_ENT), OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RCTL)
    ),
...
[_NUM] = LAYOUT_planck_grid(
    ...
    _______, KC_LCTL, LGUI_T(KC_F), LALT_T(KC_E), LSFT_T(KC_D), _______, _______, RSFT_T(KC_4), RALT_T(KC_5), RGUI_T(KC_6), RCTL_T(KC_MINS), _______,
    _______, _______, KC_C,    KC_B,    KC_A,    _______, KC_HASH, KC_1,    KC_2,    KC_3,    KC_PLUS, _______,
