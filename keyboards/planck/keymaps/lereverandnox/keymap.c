...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), LT(LNAV, KC_CAPS), LSFT_T(KC_SPC),  LT(LOWER, KC_TAB), LT(RAISE, KC_RALT), RSFT_T(KC_BSPC), LT(RNAV, KC_ENT), OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RCTL)
    ),
