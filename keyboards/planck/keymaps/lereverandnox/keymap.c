 ...
 * |      |   ;  |   Q  |   J  |   K  |   X  |   B  |   M  |   W  |   V  |   Z  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Caps |  Spc | Tab  |Enter | Bksp | Alt  | Alt  |  GUI | Ctrl |
 * |      |      |      | LNav |Shift |Lower |Raise |Shift | RNav |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_DVORAK] = LAYOUT_planck_grid(
    ...
    OSM(MOD_LCTL), OSM(MOD_LGUI), OSM(MOD_LALT), LT(LNAV, KC_CAPS), LSFT_T(KC_SPC),  LT(LOWER, KC_TAB), LT(RAISE, KC_ENT), RSFT_T(KC_BSPC), LT(RNAV, KC_RALT), OSM(MOD_RALT), OSM(MOD_RGUI), OSM(MOD_RCTL)
    ),
