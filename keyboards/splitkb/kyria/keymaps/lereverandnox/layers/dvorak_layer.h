...
[_DVORAK] = LAYOUT(
    ...
    KC_TAB,  DM_SCLN, DM_Q,    DM_J,    DM_K,    KC_X,    XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, KC_B,    DM_M,    DM_W,    DM_V,    DM_Z,    TD_RSFT,
#else
    KC_TAB,  DM_SCLN, DM_Q,    DM_J,    DM_K,    KC_X,    XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, KC_B,    DM_M,    DM_W,    DM_V,    DM_Z,    KC_RSFT,
